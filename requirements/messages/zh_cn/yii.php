...
return array (
  ...
  'PDO Oracle extension' => 'PDO Oracle扩展模块',
  'This is required if you are using Oracle database.' => '如果使用Oracle数据库，这是必须的。',
  'PDO MSSQL extension (pdo_mssql)' => 'PDO MSSQL扩展模块',
  'This is required if you are using MSSQL database from MS Windows' => '如果在Windows中使用MSSQL数据库，这是必须的。',
  'PDO MSSQL extension (pdo_dblib)' => 'PDO MSSQL扩展模块',
  'This is required if you are using MSSQL database from GNU/Linux or other UNIX.' => '如果在UNIX或Linux中使用MSSQL数据库，这是必须的。',
  'PDO MSSQL extension (<a href="http://sqlsrvphp.codeplex.com/">pdo_sqlsrv</a>)' => 'PDO MSSQL驱动模块',
  'This is required if you are using MSSQL database with the driver provided by Microsoft.' => '如果使用的微软提供的驱动程序，这是必须的。',
);
