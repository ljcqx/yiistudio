        ...
        <div class="well well-container">
            ...
            <div class="content">
                ...
                <?php elseif ($stage == 2): // Instructions for Installing Yii Framework within the runtime directory ?>
                   ...
                   <pre><?php echo str_replace('/modules/install', '', str_replace('\\','/',dirname(__FILE__) . '/runtime/')); ?></pre>
                    <p></p>
                    ...
                    <pre>chmod -R <?php echo str_replace('/modules/install', '', str_replace('\\','/',dirname(__FILE__) . '/runtime/')); ?> 777</pre>
                ...
                <?php elseif ($stage == 3): // Handles the download of Yii
                        if (!is_writeable(str_replace('/modules/install', '', str_replace('\\','/',dirname(__FILE__) . '/runtime/'))))
                ...
                <?php elseif ($stage == 10): ?>
                    ...
                    <pre>chmod -R 777 <?php echo str_replace('/modules/install', '', str_replace('\\','/',dirname(__FILE__) . '/runtime/')); ?></pre>
                    <pre>chmod -R 777 <?php echo str_replace('/modules/install', '', str_replace('\\','/',dirname(__FILE__) . '/config/')); ?></pre>
                    <pre>chmod -R 777 <?php echo str_replace('/protected/modules/install', '', strpbrk('\\','/',dirname(__FILE__) . '/assets/')); ?></pre>
                ...
                $(document).ready(function() {
                   ...
                   $.post('', 
                        { 
                            ...
                            data : { 
                                runtime : "<?php echo str_replace('/modules/install', '', str_replace('\\','/',dirname(__FILE__) . '/runtime/')); ?>",
