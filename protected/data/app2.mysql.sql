...
(
	...
	lastvisit_time INT NULL DEFAULT 0,
...
CREATE TABLE `tbl_profiles` (
  ...
  PRIMARY KEY (`uid`),
  CONSTRAINT `user_profile_id` FOREIGN KEY (`uid`) REFERENCES `tbl_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_profiles` (`uid`, `lastname`, `firstname`) VALUES
...
INSERT INTO tbl_users (username, password, salt, email, activkey, superuser, status) VALUES ('admin','2e5c7db760a33498023813489cfadc0b','28b206548469ce62182048fd9cf91760','admin@admin.com','9a24eff8c15a6a141ece27eb6947da0f', 0, 1),
('demo', '2e5c7db760a33498023813489cfadc0b','28b206548469ce62182048fd9cf91760', 'demo@demo.com', '9a24eff8c15a6a141ece27eb6947da0f', 0, 1);
